...
(function () {
  ...
  angular.module('BlurAdmin.pages.ordersAndSales.completedOrders')
    .controller('completedOrdersPropModalCtrl', completedOrdersPropModalCtrl)
    .factory('$completedOrdersPropModal', completedOrdersPropModal)

  function completedOrdersPropModal($uibModal) {
    var open = function (size, id) {
      return $uibModal.open({
        controller: 'completedOrdersPropModalCtrl',
        controllerAs: 'vm',
        animation: true,
        templateUrl: 'app/pages/ordersAndSales/completedOrder/completedOrderPropModal.html',
        size: size,
        backdrop: 'static',
        resolve: {
          items: function () {
  ...
  function completedOrdersPropModalCtrl(sessionService, $scope, Order, Partners, SubOrder, Payment, Product, Product_category, $uibModalInstance, $commonModal, toastr, items) {
    var vm = this
